    ...
    <div className="p-4 sm:p-6 lg:p-8 max-w-6xl mx-auto space-y-6 sm:space-y-8">
      ...
      <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-4">
        ...
        <div className="flex flex-wrap items-center gap-2">
          ...
          <button
            ...
            className="px-3.5 py-2 rounded-lg border border-neutral-200 hover:bg-neutral-50 text-neutral-800 text-xs font-medium transition-colors flex items-center gap-1.5 disabled:opacity-40"
          >
            {isRepairing ? (
          ...
          <button
            ...
            className="px-3.5 py-2 rounded-lg border border-neutral-200 hover:bg-neutral-50 text-neutral-800 text-xs font-medium transition-colors flex items-center gap-1.5 disabled:opacity-50"
          >
            {isRebuilding ? (
              <Loader2 className="w-3.5 h-3.5 animate-spin" />
            ) : (
      ...
      <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-3">
        ...
        <div className="p-3.5 rounded-xl border border-neutral-200 bg-white">
          ...
          <div className="text-[10px] text-neutral-400 mt-0.5 font-mono">Master & Shards</div>
        </div>
        ...
        <div className="p-3.5 rounded-xl border border-neutral-200 bg-white">
          ...
          <div className="text-[10px] text-neutral-400 mt-0.5 font-mono">0 Collisions</div>
        </div>

        <div className="p-3.5 rounded-xl border border-neutral-200 bg-white">
          <div className="flex items-center justify-between text-[11px] font-medium text-neutral-500">
            <span>Orphan Files</span>
            <FolderMinus className="w-3.5 h-3.5 text-neutral-600" />
          </div>
          <div
            className={`text-base font-bold font-mono mt-1 ${
          ...
          <div className="text-[10px] text-neutral-400 mt-0.5 font-mono">Unindexed JSON</div>
        </div>
        ...
        <div className="p-3.5 rounded-xl border border-neutral-200 bg-white">
          ...
          <div className="text-[10px] text-neutral-400 mt-0.5 font-mono">Dead Index Paths</div>
        </div>
        ...
        <div className="p-3.5 rounded-xl border border-neutral-200 bg-white">
          ...
          <div className="text-[10px] text-neutral-400 mt-0.5 font-mono">totalCount sync</div>
        </div>
      </div>
