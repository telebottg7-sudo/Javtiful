  ...
  return (
    <div className="grid grid-cols-1 lg:grid-cols-12 gap-5">
      ...
      <div className="lg:col-span-7 grid grid-cols-1 sm:grid-cols-2 gap-4">
        ...
        <div className="bg-white border border-neutral-200/90 rounded-2xl p-4 sm:p-5 shadow-xs flex flex-col justify-between relative overflow-hidden group hover:border-neutral-300 transition-all">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-2">
              ...
              <div>
                <h4 className="text-xs font-bold text-neutral-900">Cache Efficiency</h4>
                <p className="text-[10px] text-neutral-400 font-mono">In-Memory LRU</p>
              </div>
            </div>
          ...
          <div className="my-3 flex items-center justify-between gap-4">
            <div>
              <div className="text-2xl sm:text-3xl font-extrabold font-mono text-neutral-900 tracking-tight">
                {hitRatio.toFixed(1)}%
              </div>
            ...
            <div className="relative w-20 h-20 shrink-0 flex items-center justify-center">
              ...
              <div className="absolute font-mono text-[11px] font-bold text-neutral-800">
                {hitRatio.toFixed(0)}%
              </div>
            </div>
          </div>
        ...
        <div className="bg-white border border-neutral-200/90 rounded-2xl p-4 sm:p-5 shadow-xs flex flex-col justify-between relative overflow-hidden group hover:border-neutral-300 transition-all">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-2">
              ...
              <div>
                <h4 className="text-xs font-bold text-neutral-900">Query Response Time</h4>
                <p className="text-[10px] text-neutral-400 font-mono">Microsecond Bench</p>
              </div>
            </div>
          ...
          <div className="my-3">
            <div className="flex items-baseline gap-1.5">
              <span className="text-2xl sm:text-3xl font-extrabold font-mono text-neutral-900 tracking-tight">
                {avgLatency > 0 ? avgLatency.toFixed(2) : "< 0.05"}
              </span>
              <span className="text-xs font-mono font-semibold text-neutral-500">ms</span>
            </div>
            <div className="text-xs text-neutral-500 mt-0.5">
        ...
        <div className="bg-white border border-neutral-200/90 rounded-2xl p-4 sm:p-5 shadow-xs flex flex-col justify-between relative overflow-hidden group hover:border-neutral-300 transition-all">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-2">
              ...
              <div>
                <h4 className="text-xs font-bold text-neutral-900">Write Queue Mutex</h4>
                <p className="text-[10px] text-neutral-400 font-mono">Race Safety Protocol</p>
              </div>
            </div>
          ...
          <div className="my-3">
            <div className="text-2xl sm:text-3xl font-extrabold font-mono text-neutral-900 tracking-tight flex items-center gap-2">
              <span>0</span>
            ...
            <div className="mt-3 flex items-center gap-2 text-[11px] font-mono text-neutral-600 bg-neutral-50 px-2.5 py-1 rounded-lg border border-neutral-200/60">
        ...
        <div className="bg-white border border-neutral-200/90 rounded-2xl p-4 sm:p-5 shadow-xs flex flex-col justify-between relative overflow-hidden group hover:border-neutral-300 transition-all">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-2">
              ...
              <div>
                <h4 className="text-xs font-bold text-neutral-900">Database Integrity</h4>
                <p className="text-[10px] text-neutral-400 font-mono">4 Master Indexes</p>
              </div>
            </div>
      ...
      <div className="lg:col-span-5 bg-white border border-neutral-200/90 rounded-2xl p-5 shadow-xs flex flex-col justify-between space-y-4">
        <div>
          <div className="flex items-center justify-between pb-3 border-b border-neutral-100">
            ...
            <span className="text-xs font-bold font-mono text-neutral-900 bg-neutral-100 px-2.5 py-1 rounded-lg border border-neutral-200">
                ...
                <Tooltip
                  content={({ active, payload }) => {
                    if (active && payload && payload.length) {
                      ...
                      return (
                        <div className="bg-neutral-900 text-white p-2.5 rounded-lg text-xs font-mono shadow-lg border border-neutral-700">
                          <div className="font-bold text-emerald-400">{item.name}</div>
                          <div className="text-neutral-200 mt-0.5">{item.count} items recorded</div>
          ...
          {distributionData.map((item) => {
            ...
            return (
              <button
                ...
                className="p-2.5 rounded-xl border border-neutral-100 bg-neutral-50/70 hover:bg-neutral-100/90 hover:border-neutral-200 text-left transition-all group flex items-center justify-between"
              >
                <div className="flex items-center gap-2 min-w-0">
                  ...
                  <div className="truncate">
                    <div className="text-xs font-semibold text-neutral-800 truncate group-hover:text-neutral-950">
                      {item.name}
                    </div>
                ...
                <div className="text-xs font-bold font-mono text-neutral-900 shrink-0">
